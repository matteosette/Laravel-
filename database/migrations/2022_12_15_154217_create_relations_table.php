...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('plat', function (Blueprint $table) {
            // création d'une clé étrangère qui relie plat et sa photo
            $table->foreignId('photo_plat_id')->references('id')->on
            ('photo_plat');
            // création d'un index (accélérateur de recherche) pour la 
            // clé étrangère
            $table->index('photo_plat_id');

            //création d'une clé étrangère qui relie plat et sa catergorie
            $table->foreignId('categorie_id')->references('id')->on
            ('categorie');
            // création d'un index (accélérateur) pour la 
            // clé étrangère
